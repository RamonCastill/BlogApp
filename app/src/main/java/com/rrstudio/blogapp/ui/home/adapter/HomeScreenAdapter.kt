package com.rrstudio.blogapp.ui.home.adapter
...
import com.rrstudio.blogapp.core.BaseViewHolder
import com.rrstudio.blogapp.data.model.Post
import com.rrstudio.blogapp.databinding.PostItemViewBinding
...
class HomeScreenAdapter(private val postList: List<Post>): RecyclerView.Adapter<BaseViewHolder<*>>() {
    ...
    private inner class HomeScreenViewHolder(
        ...
        override fun bind(item: Post) {
            ...
            binding.timestamp.text = "Hace 2 Horas"
        }
    }
}